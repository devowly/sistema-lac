  ...
  */
  var ServerSideFilter = Backgrid.Extension.ServerSideFilter = Backbone.View.extend({
    ...
    template: function (data) {
      ...
      var html = '<span class="search">&nbsp;</span> <input type="search" ' + (data.placeholder ? 'placeholder="' + data.placeholder + '"' : '') + ' name="' + data.name + '" ' + (data.value ? 'value="' + data.value + '"' : '') + ' /> <a class="clear" data-backgrid-action="clear" href="#">&times;</a>';
